...
public class C02_JsExecutor_ScroolIntoWiev extends TestBase_BeforeAfter {
    ...
    public void test01(){
        ...
        driver.findElement(By.xpath("(//li[@class='slick-slide slick-current slick-active'])[3]")).click();
